...
export interface IKfEntreeFocusClavier {
    ...
    /**
     * Si présent et vrai, les entrées sont en lecture seule quand elles n'ont pas le focus.
     * Cette option n'est pas appliquée si une touche de début d'édition est définie.
     */
    lectureSeuleSiPasFocus?: boolean;
    ...
    /**
     * Si présent, les entrées sont initialement en lecture seule.
     * Si l'entrée a le focus quand cette touche est enfoncée, cette entrée devient éditable
     * jusqu'à ce qu'elle perde le focus ou qu'une touche de fin d'édition soit enfoncée.
     */
    toucheDébutEdition?: KfClavierTouche | KfClavierToucheEnfoncée;
     ...
     * et l'entrée redevient en lecture seule.
     */
